...
-- ==================== candidate_outcomes ====================
-- Desenlace real (24h/72h o muerte) de cada token único archivado en
-- cycle_snapshots. La otra mitad del archivador anti-superviviente:
-- permite al ReplayEngine evaluar filtros alternativos sobre el universo
-- completo, no solo sobre los tokens que siguieron siendo trending.
...
-- ==================== wallet_managed_tokens (backoffice) ====================
